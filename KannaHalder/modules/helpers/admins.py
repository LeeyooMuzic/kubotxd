...
from KannaHalder import *
from pyrogram import Client
from pyrogram.types import Message, Chat, User
from KannaHalder.modules.helpers.interval import IntervalHelper
import KannaHalder.modules.cache.admins

async def get_administrators(chat: Chat) -> List[User]:
    get = KannaHalder.modules.cache.admins.get(chat.id)
    ...
    if get:
        ...
        KannaHalder.modules.cache.admins.set(chat.id, to_set)
